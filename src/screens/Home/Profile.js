...
<View
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between',margin:20}}>
          <TouchableOpacity style={{borderRadius:15,padding:10,backgroundColor:'#E1E4F8',flexDirection:'row',alignItems:'center'}}><Text style={{fontFamily:typography.medium,color:'white',fontSize:12,color:'#453E9F'}}>Wallet</Text><MaterialIcons name={'keyboard-arrow-down'} size={16} color={'#453E9F'}/></TouchableOpacity>
